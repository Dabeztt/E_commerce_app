class AssetsManager {
  static String imagesPath = "asset/image";
  static String profileImagesPath = "asset/image/profile";
  static String bagImagesPath = "asset/image/bag";
  static String bannersImagesPath = "asset/image/banner";
  static String categoriesImagesPath = "asset/image/categories";
